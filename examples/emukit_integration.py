...
# Create GPy model
kernel = GPy.kern.RBF(1, lengthscale=0.1, variance=1.0) + GPy.kern.White(
    1, variance=1e-6
)
...
loop = ClarityBayesianOptimizationLoop(
    model=emukit_model, space=space, acquisition=acquisition
)
...
plt.suptitle("Bayesian Optimization Diagnostics Evolution", fontsize=16, y=0.995)
